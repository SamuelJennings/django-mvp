...
from .views import (
    ...
    CategoryDeleteWithRelatedWarningView,
    CategoryUpdateView,
    ComplexFormDemoView,
    DemoHomeView,
    ProductCreateView,
...
urlpatterns = [
    ...
    path(
        "categories/<int:pk>/delete/related/warning/",
        CategoryDeleteWithRelatedWarningView.as_view(),
        name="category-delete-related-warning",
    ),
