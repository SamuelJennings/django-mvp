...
test suite does NOT read this module directly — ``tests/settings.py`` inherits
from it and pins the handful of ``MVP_CONFIG`` values it asserts, so visual
changes here won't break tests.
"""
