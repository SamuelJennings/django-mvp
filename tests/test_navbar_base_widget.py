...
class TestBaseWidgetRendering:
    ...
    def test_base_widget_renders_with_icon_alias(self, cotton_render):
        """Test base widget renders with icon alias (T009)."""
        html = cotton_render("navbar.widget", icon="notification", badge_count=0)
    ...
    def test_base_widget_uses_c_icon_component(self, cotton_render):
    ...
    def test_base_widget_displays_badge_with_count(self, cotton_render):
        """Test base widget displays badge with count (T011)."""
        html = cotton_render("navbar.widget", icon="notification", badge_count=5)
        soup = BeautifulSoup(html, "html.parser")
    ...
    def test_base_widget_hides_badge_when_zero(self, cotton_render):
    ...
    def test_base_widget_renders_slot_content(self, cotton_render):
    ...
    def test_badge_supports_bootstrap_color_classes(self, cotton_render):
    ...
    def test_badge_displays_99_plus_when_count_over_99(self, cotton_render):
        """Test badge displays '99+' when count > 99 (T015)."""
        html = cotton_render("navbar.widget", icon="notification", badge_count=150)
        soup = BeautifulSoup(html, "html.parser")
    ...
    def test_base_widget_follows_adminlte_pattern(self, cotton_render):
        """Test base widget follows AdminLTE nav-item dropdown pattern (T016)."""
        html = cotton_render("navbar.widget", icon="notification", badge_count=3)
        soup = BeautifulSoup(html, "html.parser")
    ...
    def test_base_widget_handles_negative_badge_counts(self, cotton_render):
